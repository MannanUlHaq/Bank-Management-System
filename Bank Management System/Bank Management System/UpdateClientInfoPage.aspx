<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateClientInfoPage.aspx.cs" Inherits="Bank_Management_System.UpdateClientInfoPage" %>
            ...
            <button style="font-size: 13px; font-weight: bolder;" class="btn btn-outline-info ">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <li><a class="dropdown-item" href="bank-staff-login.html">Bank Staff</a></li>
                  <li><a class="dropdown-item" href="client-login.html">Client</a></li>
                </ul>
              </li>
            </button>
    ...
    <section class="add-client-inner">
        <form id="form1" runat="server" class="frame-parent29">
            <div class="add-new-client-wrapper">
                <h1 class="add-new-client">Update Client Information</h1>
            </div>
            <div class="frame-parent30">
                <div style="font-size: larger; font-weight: bold; margin-bottom: 0px;">Enter Client ID to Search:</div>

                                <div class="form-parent2">
                                <div class="form35">
                                    <div class="input23">
                                        <div class="first-name9">Client ID</div>
                                        <div class="field61">
                            <asp:TextBox ID="TextBox1" runat="server" CssClass="label55" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                        </div>
                            ...
                            <div class="frame-parent37">
                                <div class="frame-parent38">
                                    ...
                                    <div class="city-group">
                                        ...
                                        <div class="field68">
                                            <asp:TextBox ID="txtCity" runat="server" CssClass="label62" placeholder="Lahore" TextMode="SingleLine" OnTextChanged="txtCity_TextChanged"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form42">
                                        <div class="input26">
                                ...
                                <div class="form-parent4">
                                    ...
                                    <div class="password-container">
                                        ...
                                        <div class="field72">
                                            <asp:TextBox ID="txtPassword" runat="server" CssClass="label66" placeholder="J1234@" TextMode="SingleLine"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="picture-container" style="margin-top:50px">
    <div class="row-container">
    <div class="picture-box" style="margin-left:150px" >
        <asp:Image ID="Image2" runat="server" ImageUrl="PhotoBox.png"/>
    </div>
<div class="add-button-container2">
    ...
    <img class="users-icon4" loading="lazy" alt="" src="./public/users1@2x.png" />
            ...
            <div class="add-button-container">
                <asp:Button ID="Button1" runat="server" CssClass="button16" Text="Update" OnClick="Button1_Click" />
            </div>
        </form>
    </section>
</div>
