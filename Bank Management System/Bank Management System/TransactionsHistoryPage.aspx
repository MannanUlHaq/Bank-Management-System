<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionsHistoryPage.aspx.cs" Inherits="Bank_Management_System.TransactionsHistoryPage" EnableEventValidation ="false" %>
  ...
  <section class="content-area2">
    <div class="loan-application-structure">
      <div class="loan-applications-header">
        <h1 class="loan-applications2"><br />Transactions History</h1>
      </div>
          ...
          <div class="search-and-filter-area">
            <div class="input-fields-area">
              <div class="name-inputs1">
                <div class="form32">
                  <div class="input16">
                    <div class="first-name7">AccountID</div>
                    <div class="field50">
                      <asp:TextBox ID="AccIDTextBox" runat="server" CssClass="label47" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                <div class="form33">
                  <div class="input17">
                    <div class="client-id">Transaction Type</div>
                    <div class="field51">
                        <asp:TextBox ID="TextBoxtype" runat="server" CssClass="label49" placeholder="Deposite/Withdraw" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
              ...
              <div class="last-name-input-area">
                <div class="last-name7">Transaction Date</div>
                <div class="field54">
                  <asp:TextBox ID="DateTextBox" runat="server" CssClass="label51" placeholder="1 Jan 2024" TextMode="DateTime"></asp:TextBox>
                </div>
              </div>
            </div>
          </div>
