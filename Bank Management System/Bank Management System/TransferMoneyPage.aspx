<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferMoneyPage.aspx.cs" Inherits="Bank_Management_System.TransferMoneyPage" %>
    ...
    <section class="transaction-form-inner" >
        <div class="frame-parent45">
            <div class="transaction-process-wrapper">
                <h1 class="transaction-process" style="margin-right:660px"><br>Transfer Money</h1>
            </div>
                        ...
                        <div class="frame-wrapper16">
                            <div class="form-parent8">
                                ...
                                <form id="DepositForm" runat="server">
                                    <div class="form84">
                                        <div class="input47">
                                            <div class="account-id">Account ID of Sender</div>
                                                <asp:DropDownList ID="AccountIdDropDownList" runat="server" CssClass="dropdownstyle"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form85">
                                        <div class="form86">
                                            <div class="form87">
                                                ...
                                                <div class="form88">
                                                    <div class="input48">
                                                        ...
                                                        <div class="field111">
                                                            <asp:TextBox ID="AccountIdRTextBox" runat="server" CssClass="label103" placeholder="0001" type="text"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form91">
                                                    <div class="form92">
                                                        <div class="input49">
                                                            ...
                                                            <div class="field112">
                                                                <asp:TextBox ID="AmountToTransferTextBox" runat="server" CssClass="label104" placeholder="1000000" type="number"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="button-wrapper2">
                                        <asp:Button ID="TransferButton" runat="server" CssClass="button24" Text="Deposit" OnClick="TransferButton_Click" />
                                    </div>
                                </form>
                            </div>
                        </div>
