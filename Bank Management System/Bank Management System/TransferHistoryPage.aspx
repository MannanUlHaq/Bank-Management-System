<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferHistoryPage.aspx.cs" Inherits="Bank_Management_System.TransferHistoryPage" EnableEventValidation ="false" %>
  ...
  <section class="content-area2">
    <div class="loan-application-structure">
      <div class="loan-applications-header">
        <h1 class="loan-applications2"><br />Transfer History</h1>
      </div>
...
<asp:GridView ID="gv" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed table-hover"
    ...
    <Columns>
        <asp:BoundField DataField="TransferID" HeaderText="Trans ID" />
        <asp:BoundField DataField="ToAccID" HeaderText="Receiver ID" />
        <asp:BoundField DataField="TransferAmount" HeaderText="Amount" />
          ...
          <div class="search-and-filter-area">
            <div class="input-fields-area">
              <div class="name-inputs1">
                <div class="form32">
                  <div class="input16">
                    <div class="first-name7">ReceiverID</div>
                    <div class="field50">
                      <asp:TextBox ID="TextBoxR" runat="server" CssClass="label47" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
              ...
              <div class="last-name-input-area">
                <div class="last-name7">Transfer Date</div>
                <div class="field54">
                  <asp:TextBox ID="transferdateTextBox" runat="server" CssClass="label51" placeholder="Jane" TextMode="SingleLine"></asp:TextBox>
                </div>
              </div>
            </div>
          </div>
