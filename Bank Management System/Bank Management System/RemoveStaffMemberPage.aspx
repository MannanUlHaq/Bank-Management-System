<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveStaffMemberPage.aspx.cs" Inherits="Bank_Management_System.RemoveStaffMemberPage" %>
...
<div class="remove-client">
    <section class="content5">
        <h1 class="remove-client1" >Remove Member</h1>
    </section>
                        ...
                        <div class="first-name-input2">
                            <div class="first-name-label-area1">
                                ...
                                <div class="cnic-container">
                                    <div class="cnic4">Member Id</div>
                                    <div class="field84">
                                        <asp:TextBox ID="txtMemberId" runat="server" CssClass="label78" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
