<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUsPage.aspx.cs" Inherits="Bank_Management_System.ContactUsPage" %>
...
<body>
      ...
      <span class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="ContactUsPage.aspx"> &nbsp;&nbsp;&nbsp;&nbsp;Contact
                us</a>
            </li>
  ...
  <div class="contact-form">
    <div class="user-actions">
      <img class="envelope-icon" alt="" src="./public/envelope@2x.png" />

      <img class="users-icon" alt="" src="./public/users@2x.png" />
    </div>
    <section class="content">
      <div class="form-area">
        <div class="form-header">
          <h1 class="contact-us5"><br> Contact us</h1>
          <div class="seek-our-help"><br><br> Seek Our Help</div>
        </div>
        <div class="form-fields">
            ...
            <div class="email-field">
              <div class="email-label">
                ...
                <div class="contact-details">
                  <div class="l227518lhrnuedupk-l227522">
                    <p class="l227518lhrnuedupk">l227518@lhr.nu.edu.pk</p>
                    <p class="l227522lhrnuedupk">l227522@lhr.nu.edu.pk</p>
                    <p class="l227556lhrnuedupk">l227556@lhr.nu.edu.pk</p>
                    <p class="l227521lhrnuedupk">l227521@lhr.nu.edu.pk</p>
                  </div>
                </div>
              </div>
                ...
                <div class="phone-label">
                  ...
                  <div class="phone-number">
                    <div class="empty-space">
                      <p class="p">+42309-5522369</p>
                      <p class="p1">+92315-2568147</p>
                      <p class="p2">+92305-5684123</p>
                      <p class="p3">+92312-9563754</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <img class="chat-icon" loading="lazy" alt="" src="./public/chat@2x.png" />
        </div>
      </div>
    </section>
    <br><br>
