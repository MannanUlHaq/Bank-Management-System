<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductsCoordinatorDashboard.aspx.cs" Inherits="Bank_Management_System.ProductsCoordinatorDashboard" %>
...
<head>
  ...
  <link rel="stylesheet" href="./finacial-products-coordinator-dashboard.css" />
  <link rel="stylesheet"
...
<li><a class="dropdown-item" href="ClientLoginPage.aspx">Client</a></li>
    ...
    <div class="finacialproductscoordinatordas">
    <section class="welcome-banner2">
        <img class="welcome-icon3" loading="lazy" alt="" src="./public/welcome@2x.png" />
    </section>
    <section class="features-overview">
        <div class="financial-products">
            <div class="loan">
                <div class="rectangle-do9"></div>
                <img class="depositeimage-icon1" loading="lazy" alt="" src="./public/contactcustomerimage@2x.png" />

                <div class="product-details">
                    <div class="product-descriptions">
                        <h2 class="loans4">Loans</h2>
                        <div class="product-benefits">
                            <div class="boost-your-financial">
                                Boost your financial journey by simply applying for a loan.
                            </div>
                        </div>
                        <div class="product-actions">
                            <asp:Button ID="btnLoanApplication" runat="server" CssClass="addclientbutton5" Text="Apply Now" OnClick="btnLoanApplication_Click" />
                            <asp:Button ID="btnLoanInfo" runat="server" CssClass="addclientbutton5" Text="See Now" OnClick="btnLoanInfo_Click" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="debitcard2">
                <div class="rectangle-do10"></div>
                <img class="cardimage-icon" loading="lazy" alt="" src="./public/cardimage@2x.png" />

                <div class="debitcard-inner">
                    <div class="debit-card-parent">
                        <h2 class="debit-card1">Debit Card</h2>
                        <div class="simply-click-on-the-button-bel-wrapper">
                            <div class="simply-click-on">
                                Simply click on the button below for a new debit card. You can also view card details.
                            </div>
                        </div>
                        <div class="addclientbutton-group">
                            <asp:Button ID="btnCardApplication" runat="server" CssClass="addclientbutton5" Text="Apply Now" OnClick="btnCardApplication_Click" />
                            <asp:Button ID="btnCardInfo" runat="server" CssClass="addclientbutton5" Text="See Now" OnClick="btnCardInfo_Click" />
                        </div>
                    </div>
                </div>
            </div>
