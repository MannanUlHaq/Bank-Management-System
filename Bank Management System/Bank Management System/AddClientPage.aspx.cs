    ...
    public partial class AddClientPage : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = @"INSERT INTO Client (FirstName, LastName, UserName, Password, ClientPhoto, DOB, Gender, Age, Address, City, Email, Phone, CNIC)
                     VALUES (@FirstName, @LastName, @UserName, @Password, @ClientPhoto, @DOB, @Gender, @Age, @Address, @City, @Email, @Phone, @CNIC)";
