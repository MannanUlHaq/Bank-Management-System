<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankStaffLoginPage.aspx.cs" Inherits="Bank_Management_System.BankStaffLoginPage" %>
...
<head>
  ...
  <link rel="stylesheet" href="./bank-staff-login.css" />
...
<body>
  ...
  <div class="bank-staff-login">
    <section class="bank-staff-login-inner">
      <div class="frame-parent4">
        <div class="content-wrapper">
            <div class="copy2">
              <h1 class="login-to-bank">Login to Bank Staff Dashboard</h1>
              <div class="enter-your-username2">
    ...
    <asp:DropDownList ID="DropDownList2" CssClass="dropdownstyle" runat="server">
          ...
          <asp:ListItem Text="Financial Products Coordinator" Value="Financial Products Coordinator"></asp:ListItem>
    </asp:DropDownList>
              <div class="field5">
               
    <asp:TextBox ID="txtBankstaff_login" runat="server" class="label5" placeholder="Enter Your Username" ></asp:TextBox>
              </div>
              <div class="field6">
                
        <asp:TextBox ID="txtBankstaff_pswd" TextMode="Password" runat="server" class="label6" placeholder="Enter Your Password"></asp:TextBox>
              </div>
                <div class="button-container">
                    <asp:Button ID="Bankstaff_loginbtn" CssClass="button2" runat="server" Text="Login" OnClick="Bankstaff_loginbtn_Click1" />
                    </div>
          </form>
        </div>
        <div class="cursor-parent">
          <img class="cursor-icon2" alt="" src="./public/cursor@2x.png" />

          <img class="at-icon2" loading="lazy" alt="" src="./public/at@2x.png" />
        </div>
      </div>
    </section>
  </div>
