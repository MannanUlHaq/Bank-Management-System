<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAccountInfoPage.aspx.cs" Inherits="Bank_Management_System.ViewAccountInfoPage" EnableEventValidation ="false" %>
  ...
  <section class="content-area2">
    <div class="loan-application-structure">
      <div class="loan-applications-header">
        <h1 class="loan-applications2"><br />Accounts Information</h1>
      </div>
          ...
          <div class="search-and-filter-area">
            <div class="input-fields-area">
              <div class="name-inputs1">
                ...
                <div class="form33">
                  <div class="input17">
                    <div class="client-id">Account ID</div>
                    <div class="field51">
                        <asp:TextBox ID="TextAccountId" runat="server" CssClass="label49" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                <div class="loan-details-inputs">
                  <div class="loan-detail-fields">
                    <div class="loan-type1">Balance</div>
                    <div class="field52">
                      <asp:TextBox ID="BalanceTextBox" runat="server" CssClass="label49" placeholder="0000" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                  <div class="loan-detail-fields1">
                    <div class="amount">Status</div>
                    <div class="field53">
                      <asp:TextBox ID="StatusTextBox" runat="server" CssClass="label50" placeholder="Active/Not Active" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
              </div>
              <div class="last-name-input-area">
                ...
                <div class="field54">
                 ...
                 <div class="last-name7">Account Type</div>
                <div class="field54">
                  <asp:TextBox ID="TextBoxtype" runat="server" CssClass="label51" placeholder="Current/Saving" TextMode="SingleLine"></asp:TextBox>
                </div>
              </div>
            </div>
          </div>
