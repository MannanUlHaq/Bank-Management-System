<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionManagerDashboard.aspx.cs" Inherits="Bank_Management_System.TransactionManagerDashboard" %>
...
<head>
  ...
  <link rel="stylesheet" href="./trans-dashboard.css" />
...
<body>
  <div class="about-us">
    ...
    <div class="transdashboard">
    <section class="welcome-banner1">
        <img class="welcome-icon2" loading="lazy" alt="" src="./public/welcome@2x.png" />
    </section>
    <section class="transdashboard-inner">
        <div class="depositmoney-parent">
            <div class="depositmoney">
                <div class="rectangle-do7"></div>
                <div class="addclientbutton2">
                    <div class="deposit-now">Deposit Now</div>
                </div>
                <img class="depositeimage-icon" loading="lazy" alt="" src="./public/depositeimage@2x.png" />

                <div class="feature-descriptions">
                    <div class="frame-parent41">
                        <div class="deposit-withdraw-parent">
                            <h2 class="deposit-withdraw">Deposit & Withdraw</h2>
                            <div class="to-simply-deposit-or-withdraw-wrapper">
                                <div class="to-simply-deposit">
                                    To simply deposit or withdraw money fill out some information of client, which is one button away.
                                </div>
                            </div>
                        </div>
                        <div class="addclientbutton-wrapper">
                            <asp:Button ID="btnTransactionForm" runat="server" CssClass="addclientbutton3" Text="Click Now" OnClick="btnTransactionForm_Click" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="withdrawmoney">
                <div class="rectangle-do8"></div>
                <img class="widthdrawalimage-icon" loading="lazy" alt="" src="./public/widthdrawalimage@2x.png" />

                <div class="withdrawmoney-inner">
                    <div class="frame-parent42">
                        <div class="transaction-history-parent">
                            <h2 class="transaction-history">Transaction History</h2>
                            <div class="to-simply-check-the-transactio-wrapper">
                                <div class="to-simply-check">
                                    To simply check the transaction history of a client, click on the button.
                                </div>
                            </div>
                        </div>
                        <div class="addclientbutton-container">
                            <asp:Button ID="btnTransactionHistory" runat="server" CssClass="addclientbutton3" Text="Check Now" OnClick="btnTransactionHistory_Click" />
                        </div>
                    </div>
                </div>
            </div>
