<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardApplicationPage.aspx.cs" Inherits="Bank_Management_System.CardApplicationPage" %>
...
<body>
  <div class="about-us">
    ...
    <section class="page-content">
        <form id="form1" runat="server" class="form-container4">
            <div class="form-heading-area">
                <h1 class="create-account"><br />Card Application</h1>
            </div>
            <div class="form-fields2">
                <div class="name-fields">
                    <div class="name-input-area">
                        ...
                        <div class="form70">
                            <div class="input41">
                                <div class="client-id1">Account ID</div>
                                <div class="field99">
                                    <asp:TextBox ID="txtAccountID" runat="server" CssClass="label92" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="account-type-area" style ="margin-bottom: 0px">
                            <div class="account-type">Card Type</div>
                                <asp:DropDownList ID="DropDownList2" CssClass="dropdownstyle" runat="server" style ="margin-bottom: -15px">
    ...
    <div class="account-type">Pin</div>
    <div class="field101">
        <asp:TextBox ID="TextBoxPin" runat="server" CssClass="label94" placeholder="1234" TextMode="SingleLine"></asp:TextBox>
    </div>
</div>
                    </div>
                </div>
