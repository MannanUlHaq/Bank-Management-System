<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientMessageBoxPage.aspx.cs" Inherits="Bank_Management_System.ClientMessageBoxPage" EnableEventValidation ="false"%>
...
<head>
  ...
  <link rel="stylesheet" href="./admin-message-box.css" />
  <link rel="stylesheet"
...
<body>
  <div class="about-us">
    ...
    <section class="messaging-area">
        <div class="message-box-and-form">
            <div class="message-box-wrapper">
                <h1 class="message-box"><br />Message Box</h1>
            </div>
...
<asp:GridView ID="gv" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed table-hover"
    ...
    <SelectedRowStyle BackColor="#669999" Font-Bold="true" ForeColor="White" />
                ...
                <div class="user-actions1">
                    <div class="form34">
                        <div class="input18">
                            <div class="first-name8">Request Date</div>
                            <div class="field56">
                                <asp:TextBox ID="txtRequestDate" runat="server" CssClass="label52" placeholder="1 Jan 2024"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input19">
                            <div class="last-name8">Status</div>
                            <div class="field57">
                                <asp:TextBox ID="txtStatus" runat="server" CssClass="label53" placeholder="In Progress/Resolved"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input20">
                            <div class="email-address5">Email address</div>
                            <div class="field58">
                                <asp:TextBox ID="txtEmailAddress" runat="server" CssClass="label54" placeholder="email@janesfakedomain.net"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input21">
                            <div class="clients-message">Your Message</div>
                            <asp:TextBox ID="txtClientsMessage" runat="server" CssClass="field59" TextMode="MultiLine" Rows="8" Columns="31" placeholder="Client’s Message"></asp:TextBox>
                        </div>
                         <div class="input18">
                            <div class="first-name8">Reply Date</div>
                            <div class="field56">
                                <asp:TextBox ID="TextBoxReply" runat="server" CssClass="label52" placeholder="1 Jan 2024"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input22">
                            <div class="admins-reply">Admin's Reply</div>
                            <asp:TextBox ID="txtAdminsReply" runat="server" CssClass="field60" TextMode="MultiLine" Rows="8" Columns="31" placeholder="Admin's Reply"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
