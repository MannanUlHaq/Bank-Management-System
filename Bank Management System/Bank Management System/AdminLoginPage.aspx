<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLoginPage.aspx.cs" Inherits="Bank_Management_System.AdminLoginPage" %>
    ...
    <div class="admin-login">
        ...
        <section class="content-panel-wrapper">
            <div class="content-panel4">
                <div class="content1">
                    <div class="copy">
                        <h1 class="login-to-admin">Login to Admin Dashboard</h1>
