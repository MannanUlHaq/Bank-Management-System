<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonalInfoPage.aspx.cs" Inherits="Bank_Management_System.PersonalInfoPage" %>
    ...
    <section class="add-client-inner">
        <form id="form1" runat="server" class="frame-parent29">
            <div class="add-new-client-wrapper">
                <h1 class="add-new-client">Personal Information</h1>
            </div>
...
<div class="picture-container">
    ...
    <div class="picture-box" style="margin-left:250px">
