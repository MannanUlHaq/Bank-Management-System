<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountandCardInfoPage.aspx.cs" Inherits="Bank_Management_System.AccountandCardInfoPage" %>
...
<head>
  ...
  <link rel="stylesheet" href="./account-card-info.css" />
...
<body>
  ...
  <div class="account-card-info">
    <section class="account-information3">
      <div class="card-info-area">
        <div class="information-title">
          <h1 class="account-and-card"> <br>Account and Card Information</h1>
        </div>
                    <div class="row">
...
<asp:GridView ID="gv" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed table-hover"
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="form-group">
            <div class="table-scroll">
<asp:GridView ID="GridView1" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed table-hover"
    runat="server">
    <Columns>
