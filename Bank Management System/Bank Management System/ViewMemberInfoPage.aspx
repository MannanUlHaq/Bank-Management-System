<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMemberInfoPage.aspx.cs" Inherits="Bank_Management_System.ViewMemberInfoPage" EnableEventValidation ="false"%>
    ...
    <main class="client-info-inner">
        <section class="frame-section">
            <div class="client-information-wrapper">
                <h1 class="client-information1"><br /> Bank Staff Information</h1>
            </div>
                ...
                <div class="frame-parent14">
                    <div class="frame-parent16">
                        ...
                        <div class="address-parent">
                            ...
                            <div class="field13">
                                <asp:TextBox ID="txtPhone" runat="server" CssClass="label12" placeholder="987654321" TextMode="SingleLine"></asp:TextBox>
                            </div>
                        </div>
                        <div class="frame-parent20">
                            <div class="frame-parent21">
                                <div class="cnic-parent">
                                    <div class="cnic1">Username</div>
                                    <div class="field14">
                                        <asp:TextBox ID="txtUsername" runat="server" CssClass="label13" placeholder="Jane1234" TextMode="SingleLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="city-parent">
                                    <div class="city">Designation</div>
                                    <div class="field15">
                                        <asp:TextBox ID="txtDesignation" runat="server" CssClass="label14" placeholder="Role" TextMode="SingleLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-parent1">
                                <div class="form9">
                                    <div class="form10">
                                        <div class="input5">
                                            <div class="date-of-birth">Password</div>
                                            <div class="field17">
                                                <asp:TextBox ID="txtPassword" runat="server" CssClass="label16" placeholder="J1234@" TextMode="SingleLine"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
