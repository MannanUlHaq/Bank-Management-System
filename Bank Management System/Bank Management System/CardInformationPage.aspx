<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardInformationPage.aspx.cs" Inherits="Bank_Management_System.CardInformation" EnableEventValidation ="false" %>
  ...
  <section class="content-area2">
    <div class="loan-application-structure">
      <div class="loan-applications-header">
        <h1 class="loan-applications2"><br />Card Information</h1>
      </div>
          ...
          <div class="search-and-filter-area">
            <div class="input-fields-area">
              <div class="name-inputs1">
                <div class="form32">
                  <div class="input16">
                    <div class="first-name7">Card ID</div>
                    <div class="field50">
                      <asp:TextBox ID="CardIdTextBox" runat="server" CssClass="label47" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                <div class="loan-details-inputs">
                  <div class="loan-detail-fields">
                    <div class="loan-type1">Card Type</div>
                    <div class="field52">
                      <asp:TextBox ID="CardTypeTextBox" runat="server" CssClass="label49" placeholder="Silver/Gold/Platinum" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                  <div class="loan-detail-fields1">
                    <div class="amount">16-Digit Card Number</div>
                    <div class="field53">
                      <asp:TextBox ID="CardNumberTextBox" runat="server" CssClass="label50" placeholder="0000000000000012" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                  <div class="form33">
                  <div class="input17">
                    <div class="client-id">Pin</div>
                    <div class="field51">
                        <asp:TextBox ID="TextBoxPin" runat="server" CssClass="label49" placeholder="1234" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                   <div class="form33">
                  <div class="input17">
                    <div class="client-id">Status</div>
                    <div class="field51">
                        <asp:TextBox ID="TextBoxStatus" runat="server" CssClass="label49" placeholder="Active/Inactive" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                </div>
              ...
              <div class="last-name-input-area">
                <div class="last-name7">Account ID</div>
                <div class="field54">
                  <asp:TextBox ID="AccountIdTextBox" runat="server" CssClass="label51" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                </div>
              </div>
            </div>
          </div>
