<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanInformationPage.aspx.cs" Inherits="Bank_Management_System.LoanInformationPage" EnableEventValidation ="false"%>
  ...
  <section class="content-area2">
    <div class="loan-application-structure">
      <div class="loan-applications-header">
        <h1 class="loan-applications2"><br />Loan Information</h1>
      </div>
          ...
          <div class="search-and-filter-area">
            <div class="input-fields-area">
              <div class="name-inputs1">
                <div class="form32">
                  <div class="input16">
                    <div class="first-name7">Loan ID</div>
                    <div class="field50">
                      <asp:TextBox ID="LoanIDTextBox" runat="server" CssClass="label47" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                <div class="loan-details-inputs">
                  ...
                  <div class="form33">
                  <div class="input17">
                    <div class="client-id">Approval date</div>
                    <div class="field51">
                        <asp:TextBox ID="TextBoxdate" runat="server" CssClass="label49" placeholder="1 Jan 2024" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                   <div class="form33">
                  <div class="input17">
                    ...
                    <div class="field51">
                        <asp:TextBox ID="TextBoxstatus" runat="server" CssClass="label49" placeholder="Pending/Approved" TextMode="SingleLine"></asp:TextBox>
                    </div>
                  </div>
                </div>
                </div>
              ...
              <div class="last-name-input-area">
                <div class="last-name7">Clinet ID</div>
                <div class="field54">
                  <asp:TextBox ID="ClientIdTextBox" runat="server" CssClass="label51" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                </div>
              </div>
            </div>
          </div>
