<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateAccountPage.aspx.cs" Inherits="Bank_Management_System.CreateAccountPage" %>
    ...
    <section class="page-content">
        <form id="form1" runat="server" class="form-container4">
            <div class="form-heading-area">
                <h1 class="create-account"><br />Create Account</h1>
            </div>
                    ...
                    <div class="name-input-area">
                        ...
                        <div class="form70">
                            <div class="input41">
                                ...
                                <div class="field99">
                                    <asp:TextBox ID="txtClientID" runat="server" CssClass="label92" placeholder="Jane1234" TextMode="SingleLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
      ...
      <asp:ListItem Text="Current" Value="Current"></asp:ListItem>
            ...
            <asp:Button ID="btnCreateAccount" runat="server" CssClass="button21" Text="Create" OnClick="btnCreateAccount_Click" />
        </form>
    </section>
    <br />
</div>
