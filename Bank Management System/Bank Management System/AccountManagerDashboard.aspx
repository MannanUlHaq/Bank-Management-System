<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountManagerDashboard.aspx.cs" Inherits="Bank_Management_System.AccountManagerDashboard" %>
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./acc-dashboard.css" />
  ...
  <body style="background-color: #4575AD;">
...
<div class="welcome-banner">
    <img class="welcome-icon1" loading="lazy" alt="" src="./public/welcome@2x.png" />
</div>
<section class="main-interactive-area">
    <div class="addclient-parent">
        <div class="addclient">
            <div class="rectangle-do5"></div>
            <img class="newclientimage-icon" loading="lazy" alt="" src="./public/newclientimage@2x.png" />

            <div class="action-containers-wrapper">
                <div class="action-containers">
                    <div class="bank-client-wrapper">
                        <h2 class="bank-client">Bank Client</h2>
                    </div>
                    <div class="staff-action-buttons">
                        <div class="button-pairs">
                            <asp:Button ID="btnAddClient" runat="server" CssClass="dropstaffbutton2" Text="Add Now" OnClick="btnAddClient_Click" />
                            <asp:Button ID="btnRemoveClient" runat="server" CssClass="dropstaffbutton2" Text="Remove Now" OnClick="btnRemoveClient_Click" />
                        </div>
                        <div class="staff-view-buttons">
                            <asp:Button ID="btnSeeClient" runat="server" CssClass="dropstaffbutton2" Text="See Now" OnClick="btnSeeClient_Click" />
                            <asp:Button ID="btnUpdateClient" runat="server" CssClass="dropstaffbutton2" Text="Update Now" OnClick="btnUpdateClient_Click" />
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="accuntshandling">
            <div class="rectangle-do6"></div>
            <img class="accimage-icon" loading="lazy" alt="" src="./public/accimage@2x.png" />

            <div class="accuntshandling-inner">
                <div class="account-handling-parent">
                    <h2 class="account-handling">Account Handling</h2>
                    <div class="frame-parent24">
                        <div class="to-simply-create-and-view-acco-wrapper">
                            <div class="to-simply-create">
                                To simply create and view accounts for client click on the buttons.
                            </div>
                        </div>
                        <div class="addclientbutton-parent">
                            <asp:Button ID="btnCreateAccount" runat="server" CssClass="dropstaffbutton2" Text="Create Now" OnClick="btnCreateAccount_Click" />
                            <asp:Button ID="btnViewAccounts" runat="server" CssClass="dropstaffbutton2" Text="See Now" OnClick="btnViewAccounts_Click" />
                        </div>
                    </div>
                </div>
            </div>
