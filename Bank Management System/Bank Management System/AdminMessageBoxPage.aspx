<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminMessageBoxPage.aspx.cs" Inherits="Bank_Management_System.AdminMessageBoxPage" EnableEventValidation ="false"%>
  ...
  <div class="about-us">
    ...
    <SelectedRowStyle BackColor="#669999" Font-Bold="true" ForeColor="White" />
                ...
                <div class="user-actions1">
                    <div class="form34">
                        <div class="input18">
                            <div class="first-name8">First name</div>
                            <div class="field56">
                                <asp:TextBox ID="txtFirstName" runat="server" CssClass="label52" placeholder="Jane"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input19">
                            <div class="last-name8">Last name</div>
                            <div class="field57">
                                <asp:TextBox ID="txtLastName" runat="server" CssClass="label53" placeholder="Smitherton"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input20">
                        ...
                        <div class="input21">
                            <div class="clients-message">Client's Message</div>
                        ...
                        <div class="input22">
                            ...
                            <asp:TextBox ID="txtAdminsReply" runat="server" CssClass="field60" TextMode="MultiLine" Rows="8" Columns="31" placeholder="Enter your reply"></asp:TextBox>
                        </div>
                        <asp:Button ID="btnSubmit" runat="server" CssClass="button14" Text="Submit" OnClick="btnSubmit_Click" />
                    </div>
                </div>
            </div>
        </div>
