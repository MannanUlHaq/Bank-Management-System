<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateStaffMemberInfoPage.aspx.cs" Inherits="Bank_Management_System.UpdateStaffMemberInfoPage" %>
    ...
    <section class="form-container1">
        <form id="form1" runat="server" class="form-header1">
            <div class="form-title-area">
                <h1 class="add-staff-member">Update Staff Member Information</h1>
            </div>
            <div class="input-fields">
                <div class="name-inputs">
                    <div style="font-size: larger; font-weight: bold; margin-bottom: 0px;">Enter Member ID to Search:</div>

                                                    <div class="first-name-field">
                                    <div class="form15">
                                        <div class="input7">
                                            <div class="first-name2">MemberID</div>
                                            <div class="field20">
                                                <asp:TextBox ID="TextBox1" runat="server" CssClass="label19" placeholder="0001" TextMode="SingleLine"></asp:TextBox>
                                            </div>
                         <div class="add-button-area" style="margin-right: 0px;">
                             <asp:Button ID="Button2" runat="server" CssClass="button7" Text="Enter" OnClick="Button2_Click" />
                        </div>
                                        </div>
                                    </div>
                                </div><b></b>
                    ...
                    <div class="credentials-input">
                        <div class="username-input-area">
                            ...
                            <div class="password-input-area">
                                ...
                                <div class="field27">
                                     <asp:TextBox ID="TextBoxPassword" runat="server" CssClass="label26" placeholder="J1234@" TextMode="SingleLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="field28">
                            <asp:TextBox ID="txtDesignation" runat="server" CssClass="label27" placeholder="Admin/Account Manager/Transaction Manager" TextMode="SingleLine"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="action-area">
                    <div class="users-button-area">
                        ...
                        <div class="add-button-area" style="margin-right: 0px;">
                            <asp:Button ID="Button1" runat="server" CssClass="button6" Text="Update" OnClick="Button1_Click" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          <div class="col-2">
            ...
            <ul class="nav flex-column ">
              <li class="nav-item mb-2"><a href="HomePage.aspx" class="nav-link p-0 ">Home</a></li>
              <li class="nav-item mb-2"><a href="AboutUsPage.aspx" class="nav-link p-0 ">About us</a></li>
              <li class="nav-item mb-2"><a href="ResourcesPage.aspx" class="nav-link p-0 ">Resources</a></li>
              <li class="nav-item mb-2"><a href="ServicesPage.aspx" class="nav-link p-0 ">Services</a></li>
            </ul>
          </div>
          ...
          <div class="col-2">
            <h5>Help desk</h5>
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="ContactUsPage.aspx" class="nav-link p-0">Contact us</a></li>
